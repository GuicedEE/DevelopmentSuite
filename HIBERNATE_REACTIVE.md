Hibernate Reactive 4.2.3.Final Reference Documentation
Davide D’Alto
davide@hibernate.org
Gavin King
gavin@hibernate.org
version 4.2.3.Final
4.2
...
the Jakarta Persistence 3.2 specification, or
...
include Hibernate Reactive itself, along with the appropriate Vert.x reactive database client, as dependencies of your project, and
